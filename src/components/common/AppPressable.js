...
export const AppPressable = forwardRef(function AppPressable({ style, onFocus, onBlur, disabled, suppressDisabledOpacity = false, accessibilityState, activeOpacity = interactions.activeOpacity, ...props }, ref) {
  ...
  return <TouchableOpacity ref={ref} activeOpacity={activeOpacity} {...props} disabled={disabled}
    ...
    style={[style, disabled && !suppressDisabledOpacity && { opacity: interactions.disabledOpacity }, focused && Platform.select({
