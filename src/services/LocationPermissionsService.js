...
export const LocationPermissionsService = () => {
  ...
  const showMandatoryGPSAlert = () => {
    Alert.alert(
      'GPS Obrigatório',
      'Este aplicativo não pode funcionar sem o GPS ativado. Por favor, ative o GPS nas configurações.',
      [
        {
          text: 'Configurações',
          onPress: () => {
  ...
  const showMandatoryPermissionAlert = () => {
    Alert.alert(
      ...
      'Este aplicativo precisa de acesso à localização para funcionar. Por favor, conceda a permissão nas configurações.',
      [
        {
          text: 'Configurações',
          onPress: () => {
